# .6cy v0.3.0 Benchmark Report
### 6cy (LZMA) vs 7-Zip (LZMA2 level 1) — 10 GiB Sequential Data

> **Status:** Official pre-release benchmark, v0.3.0  
> **Date:** 2026  
...
- .6cy v0.3.0 binary on `PATH` as `6cy.exe`
...
*This document is part of the .6cy v0.3.0 release.*  
