...
*   **Integrity Checks**: Per-block CRC32C checksums are used to detect data corruption during streaming or storage.
...
*   **Data Corruption**: Detection of accidental or intentional bit-flips in the stored data.
