...
2. **Mandatory integrity verification.** Both a per-header CRC32 and a
...
This document describes **format version 2** (used by implementation v2.0.0).
Earlier versions (v1.x) are read-compatible for extraction only.
